...
import com.openrelativefile.Actions.OpenRelativeFileAction
import com.openrelativefile.Actions.SearchFileInPathAction
import com.openrelativefile.Actions.SearchRelativeFileAction
...
fun checkActionNames(globalSettings: GlobalSettingsComponent?, projectSettings: ProjectSettingsComponent?) : String? {
    ...
    if (projectSettings!= null) {
        names = projectSettings.openRelativeFileActionsTable.getData().map{ action -> OpenRelativeFileAction.getActionName(action) }
...
fun checkShortcuts(globalSettings: GlobalSettingsComponent?, projectSettings: ProjectSettingsComponent?) : String? {
    ...
    if (projectSettings != null) {
        shortcuts = projectSettings.openRelativeFileActionsTable.getData().map{ action -> OpenRelativeFileAction.getActionShortcut(action) }
