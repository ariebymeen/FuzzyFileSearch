...
class CommonSettingsComponent(mSettings: GlobalSettings.SettingsState) {
    var panel: JPanel
    ...
    init {
        ...
        val builder = FormBuilder()
            ...
            .addComponent(
                createLabelWithDescription(
                    "Excluded folders",
                    "Wildcards are not supported, enter the full name of the folder"))
        ...
        keeper.createTextFieldComponent(
            mSettings.common::openInVerticalSplit, builder, "Shortcut open file in vertical split", """
                    Set the shortcut for opening the selected file in a vertical split view""".trimIndent())
        keeper.createTextFieldComponent(
            mSettings.common::openInHorizontalSplit, builder, "Shortcut open file in horizontal split", """
        ...
        keeper.createCheckboxComponent(
            mSettings.common::openWithSingleClick, builder, "Open file with a single click", """
        ...
        keeper.createJBIntSpinnerComponent(
            ...
            """Choose the font size""")
        keeper.createCheckboxComponent(
            mSettings.common::showScrollbar, builder, "Show scroll bar in search view", """
                    If checked the scrollbar will be shown on the side if applicable""".trimIndent())
