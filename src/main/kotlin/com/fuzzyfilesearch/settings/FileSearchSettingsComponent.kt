...
//            mSettings, 0, 3, utils::registerOpenRelativeFileActions)

        // Create relative search actions table
//        builder.addSeparator()
//        keeper.createActionsTableComponent(
//            mSettings::searchRelativeFileActions,
//            builder,
//            "Create action for searching files related to relative path",
//            """
...
//                """.trimIndent(),
//            arrayOf("Name", "Path", "Extensions", "Shortcut"),
//            arrayOf("ActionName", "/", ".txt, .md", "alt shift H"),
//            arrayOf(2, 2, 1, 2),
//            mSettings,
//            0,
//            3,
//            utils::registerSearchRelativeFileActions)

        // Create search files matching pattern actions table
//        builder.addSeparator()
//        keeper.createActionsTableComponent(
//            mSettings::searchFilesMatchingPatterActions,
//            builder,
//            "Search for files matching pattern",
//            """
//                    Search through all files where the filename matches a regex""".trimIndent(),
//            arrayOf("MyActionName", "/", "Regex", "alt ctrl P"),
//            arrayOf("MyActionName", "Regex", "h", "alt shift P"),
//            arrayOf(2, 3, 1, 2),
//            mSettings,
//            0,
//            3,
//            utils::registerSearchFileMatchingPatternActions)
        // Create file in path search actions
//        builder.addSeparator()

//        keeper.createActionsTableComponent(
//            mSettings::searchRecentFilesActions,
//            builder,
//            "Search in most recently opened files",
//            """
...
//                If the extension is empty, include all""".trimIndent(),
//            arrayOf("Name", "History length", "Extensions", "Shortcut"),
//            arrayOf("SearchRecentFiles", "10", ".txt,.md", "alt shift R"),
//            arrayOf(2, 1, 1, 2),
//            mSettings,
//            0,
//            3,
//            utils::registerSearchRecentFiles)
//        keeper.createActionsTableComponent(
//            mSettings::searchOpenFilesActions, builder, "Search in all files currently open in editor", """
...
//            mSettings, 0, 2, utils::registerSearchOpenFiles)
...
//            """Special action to search thr   ough all files""".trimIndent(),arrayOf("Name", "Extensions", "Shortcut"), arrayOf("SearchAllFiles", "", "alt shift O"),
